...
import bajajlogo from './imgss/Book_Store_Logo_in_Dark_Green_Yellow_Illustrative_Style__2_-removebg-preview.png'
          ...
          <div className="nav-hover-div">
            ...
            <div className="dropdown4">
              ...
              <div className="dropdown-content-4">
                ...
                <Link to="./Card">
                  <button className="nav-hover-bt">Secure finserv</button>{" "}
                </Link>
              </div>
            </div>
            ...
            <div className="dropdown8">
              ...
              <div className="dropdown-content-8">
                ...
                <Link to="./Card">
                  <button className="nav-hover-bt">Secure loans</button>{" "}
                </Link>
                <Link to="./Card">
